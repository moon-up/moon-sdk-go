...
// checks if the RippleTransactionInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RippleTransactionInput{}
...
type NullableRippleTransactionInput struct {
	value *RippleTransactionInput
	isSet bool
}

func (v NullableRippleTransactionInput) Get() *RippleTransactionInput {
	return v.value
}

func (v *NullableRippleTransactionInput) Set(val *RippleTransactionInput) {
	v.value = val
	v.isSet = true
}

func (v NullableRippleTransactionInput) IsSet() bool {
	return v.isSet
}
...
func NewNullableRippleTransactionInput(val *RippleTransactionInput) *NullableRippleTransactionInput {
	return &NullableRippleTransactionInput{value: val, isSet: true}
}
