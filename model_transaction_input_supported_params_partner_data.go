...
func (o *TransactionInputSupportedParamsPartnerData) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTransactionInputSupportedParamsPartnerData)
