...
func (r ApiGetMessageRequest) Execute() (*PingResponse, *http.Response, error) {
...
*/
func (a *DefaultAPIService) GetMessage(ctx context.Context) ApiGetMessageRequest {
	return ApiGetMessageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return PingResponse
func (a *DefaultAPIService) GetMessageExecute(r ApiGetMessageRequest) (*PingResponse, *http.Response, error) {
	var (
