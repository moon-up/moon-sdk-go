...
func (o *TransactionInputSupportedParamsPartnerDataRedirectUrl) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTransactionInputSupportedParamsPartnerDataRedirectUrl)
