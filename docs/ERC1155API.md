...
> AccountControllerResponse BalanceOf(ctx, name).Authorization(authorization).Erc1155Request(erc1155Request).Execute()
...
> AccountControllerResponse BalanceOfBatch(ctx, name).Authorization(authorization).Erc1155Request(erc1155Request).Execute()
...
> AccountControllerResponse IsApprovedForAll(ctx, name).Authorization(authorization).Erc1155Request(erc1155Request).Execute()
...
> AccountControllerResponse SafeBatchTransferFrom(ctx, name).Authorization(authorization).Erc1155Request(erc1155Request).Execute()
...
> AccountControllerResponse SafeTransferFrom(ctx, name).Authorization(authorization).Erc1155Request(erc1155Request).Execute()
...
> AccountControllerResponse SetApprovalForAll(ctx, name).Authorization(authorization).Erc1155Request(erc1155Request).Execute()
