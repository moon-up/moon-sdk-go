...
> AccountControllerResponse CreateEosAccount(ctx).Authorization(authorization).EosInput(eosInput).Execute()
...
func main() {
    ...
    // response from `CreateEosAccount`: AccountControllerResponse
...
> AccountControllerResponse GetEosAccount(ctx, accountName).Authorization(authorization).Execute()
...
func main() {
    ...
    // response from `GetEosAccount`: AccountControllerResponse
...
> AccountControllerResponse ListEosAccounts(ctx).Authorization(authorization).Execute()
...
func main() {
    ...
    // response from `ListEosAccounts`: AccountControllerResponse
...
> AccountControllerResponse SignEosTransaction(ctx, accountName).Authorization(authorization).EosTransactionInput(eosTransactionInput).Execute()
...
func main() {
    ...
    // response from `SignEosTransaction`: AccountControllerResponse
