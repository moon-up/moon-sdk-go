...
> AccountControllerResponse CreateRippleAccount(ctx).Authorization(authorization).RippleInput(rippleInput).Execute()
...
> AccountControllerResponse GetRippleAccount(ctx, accountName).Authorization(authorization).Execute()
...
> AccountControllerResponse ListRippleAccounts(ctx).Authorization(authorization).Execute()
...
> AccountControllerResponse SignRippleTransaction(ctx, accountName).Authorization(authorization).RippleTransactionInput(rippleTransactionInput).Execute()
