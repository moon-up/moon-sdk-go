...
> AccountControllerResponse CreateSolanaAccount(ctx).Authorization(authorization).SolanaInput(solanaInput).Execute()
...
> AccountControllerResponse GetSolanaAccount(ctx, accountName).Authorization(authorization).Execute()
...
> AccountControllerResponse ListSolanaAccounts(ctx).Authorization(authorization).Execute()
...
> AccountControllerResponse SignSolanaTransaction(ctx, accountName).Authorization(authorization).SolanaTransactionInput(solanaTransactionInput).Execute()
