...
> AccountControllerResponse CreateBitcoinAccount(ctx).Authorization(authorization).BitcoinInput(bitcoinInput).Execute()
...
> AccountControllerResponse GetBitcoinAccount(ctx, accountName).Authorization(authorization).Execute()
...
> AccountControllerResponse ListBitcoinAccounts(ctx).Authorization(authorization).Execute()
...
> AccountControllerResponse SignBitcoinTransaction(ctx, accountName).Authorization(authorization).BitcoinTransactionInput(bitcoinTransactionInput).Execute()
