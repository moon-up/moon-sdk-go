...
> AccountControllerResponse CreateBitcoinCashAccount(ctx).Authorization(authorization).BitcoinCashInput(bitcoinCashInput).Execute()
...
> AccountControllerResponse GetBitcoinCashAccount(ctx, accountName).Authorization(authorization).Execute()
...
> AccountControllerResponse ListBitcoinCashAccounts(ctx).Authorization(authorization).Execute()
...
> AccountControllerResponse SignBitcoinCashTransaction(ctx, accountName).Authorization(authorization).BitcoinCashTransactionInput(bitcoinCashTransactionInput).Execute()
