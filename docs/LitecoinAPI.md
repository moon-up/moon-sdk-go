...
> AccountControllerResponse CreateLitecoinAccount(ctx).Authorization(authorization).LitecoinInput(litecoinInput).Execute()
...
> AccountControllerResponse GetLitecoinAccount(ctx, accountName).Authorization(authorization).Execute()
...
> AccountControllerResponse ListLitecoinAccounts(ctx).Authorization(authorization).Execute()
...
> AccountControllerResponse SignLitecoinTransaction(ctx, accountName).Authorization(authorization).LitecoinTransactionInput(litecoinTransactionInput).Execute()
