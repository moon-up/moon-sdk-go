...
> AccountControllerResponse AddLiquidity(ctx, name).Authorization(authorization).UniswapInput(uniswapInput).Execute()
...
> AccountControllerResponse RemoveLiquidity(ctx, name).Authorization(authorization).UniswapInput(uniswapInput).Execute()
...
> AccountControllerResponse SwapExactETHForTokens(ctx, name).Authorization(authorization).UniswapInput(uniswapInput).Execute()
...
> AccountControllerResponse SwapExactTokensForTokens(ctx, name).Authorization(authorization).UniswapInput(uniswapInput).Execute()
