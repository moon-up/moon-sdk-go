...
> AccountControllerResponse CreateTronAccount(ctx).Authorization(authorization).TronInput(tronInput).Execute()
...
> AccountControllerResponse GetTronAccount(ctx, accountName).Authorization(authorization).Execute()
...
> AccountControllerResponse ListTronAccounts(ctx).Authorization(authorization).Execute()
...
> AccountControllerResponse SignTronTransaction(ctx, accountName).Authorization(authorization).TronTransactionInput(tronTransactionInput).Execute()
